...
@
  ...
  of all $\genfrac(){0pt}{2}{50}{2}$ intersections of selected features and present the 
  ...
  methods that require this extra tuning parameter. The AUCs calculated on the
  validation set are presented in Figure 
...
@
  ...
  \section{Choice of \texorpdfstring{$\alpha$}{alpha}}	
