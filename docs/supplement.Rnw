...
@
  ...
  \ref{fig:boxplots_micrornaseq_colorectal_cancer_res4_multipliers} presents 
...
@
  ...
  \section{Choice of $\alpha$}	
	Choice of $\alpha$ does matter in Figure 
	\ref{fig:lines_colorectal_lymph_node_gren_auc}.
<<lines_colorectal_lymph_node_gren_auc, fig.cap="Estimated AUC for gren in the (a) colorectal cancer example and the (b) lymph node metastasis example.", out.width="100%", fig.asp=1/2>>=
@
