...
<<lines_rnaseq_lymph_node_metastasis_res1_auc, fig.cap="Cross-validated AUC in lymph node metastasis example, with a) the full range and b) cut-out", out.width="100%", fig.asp=2/3>>=
@
