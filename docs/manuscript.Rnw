...
<<barplot_lines_micrornaseq_colorectal_cancer_res1_auc, fig.cap="Results for the colorectal cancer example with (a) the estimated penalty multipliers and (b) estimated AUC.", out.width="100%", fig.asp=1/2>>=
@
