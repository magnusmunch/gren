...
\begin{document}
  ...
  (ii) classes of metabolites (SM Section 12),
  and (iii) conservation status of microRNAs (SM Section 
  13).
  ...
  different, related study (Section \ref{sec:colorectal}), and
  (v) quality scores of the features (SM Section 12), 
