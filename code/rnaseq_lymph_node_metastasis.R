...
class(fit.ogel3) <- c("cv.grpregOverlap", "cv.grpreg")}, times=1, 
...
write.table(bench, file="results/rnaseq_lymph_node_metastasis_bench1.csv")

save(fit.grridge, fit.gren1, fit.gren2, fit.gren3, fit.sgl1, fit.sgl2,
     fit.sgl3, fit.cmcp1, fit.cmcp2, fit.cmcp3, fit.gel1, fit.gel2,
     fit.gel3, file="results/rnaseq_lymph_node_metastasis_fit1.Rdata")
...
write.table(res, file="results/rnaseq_lymph_node_metastasis_res1.csv")
